...
#   total = 0
#   hash = {}
#   while director_data == directors_database[director_movies][:name] do
#   total += directors_database[:movies][director_movies][:worldwide_gross]
#   director_movies += 1
#   puts total
# end 
# hash[director_data] = total
# end
...
director_movies = 0 
total = 0
while director_movies < director_data[:movies].length do 
  total += director_data[:movies][director_movies][:worldwide_gross]
  director_movies += 1 
end 
total
end 
